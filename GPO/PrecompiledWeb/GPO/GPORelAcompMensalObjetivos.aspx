<%@ page language="C#" masterpagefile="~/masterpages/Interno.master" autoeventwireup="true" inherits="GPORelAcompMensalObjetivos, App_Web_l2naqbkc" enableEventValidation="false" stylesheettheme="Padrao" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:UpdatePanel ID="upnPrincipal" runat="server">
        <contenttemplate>
    <h1>
        <asp:Label ID="lblTitulo" runat="server" EnableViewState="False">Acompanhamento Mensal dos Objetivos</asp:Label></h1>
    <br />
        ...
        <div id="filtro">
            <table width="100%">
                <tbody>
                    <tr>
                        <td>
                            <asp:Label ID="Label13" runat="server" Text="Tipo de Relatório:" EnableViewState="False"></asp:Label></td>
                        <td>
                            <asp:DropDownList ID="TIPO" runat="server" EnableViewState="False">
                                <asp:ListItem Value="V">Acompanhamento Mensal dos Objetivos (Valores)</asp:ListItem>
                                <asp:ListItem Value="S">Acompanhamento Mensal dos Objetivos (Símbolos)</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="ID_EXECUTIVO"
                                Display="Dynamic" EnableViewState="False" ErrorMessage="Selecione o Órgão!" InitialValue="-1">*</asp:RequiredFieldValidator>
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="Label1" runat="server" Text="*Mês:" EnableViewState="False"></asp:Label></td>
                        <td>
                            ...
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator14" runat="server" ErrorMessage="Selecione o Mês!"
