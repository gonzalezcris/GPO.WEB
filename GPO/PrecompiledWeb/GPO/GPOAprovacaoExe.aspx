<%@ page language="C#" masterpagefile="~/masterpages/Interno.master" autoeventwireup="true" inherits="GPOAprovacaoExe, App_Web_l2naqbkc" enableEventValidation="false" stylesheettheme="Padrao" %>
...
document.aspnetForm.submit();
    ...
    <asp:UpdatePanel ID="upnPrincipal" runat="server">
        <ContentTemplate>
            <h1>
                <asp:Label ID="lblTitulo" runat="server" EnableViewState="False">Aprovação Executivo</asp:Label></h1>
            <br />
            <asp:Panel ID="pnlIncluir" runat="server">
                ...
                <div id="botao">
                    ...
                    <asp:Button ID="btnAprovar" runat="server" Text="Aprovar" Width="80px" OnClientClick="return(confirm('Confirma a aprovação de todos os objetivos?'))"
                        OnClick="btnAprovar_Click" />
                    <asp:Button ID="btnAprovarTodos" runat="server" Text="Aprovar Todos" Width="120px" OnClientClick="return(confirm('Confirma a aprovação de todos os objetivos?'))"
                        OnClick="btnAprovarTodos_Click" Visible="false" />
                </div>
            </asp:Panel>
            <br />
            <div id="topo">
            ...
            <div id="grid">
                        ...
                        <asp:TemplateField>
                            ...
                            <HeaderTemplate>
                                <input id="ckbHeader" type="checkbox" runat="server" name="ckbHeader" checked="false"
                                    onclick="JavaScript:MarcarTodos(this);" visible="false">
                            </HeaderTemplate>
                            <ItemTemplate>
                ...
                <asp:ObjectDataSource ID="odsGrvPrincipal" runat="server" SelectMethod="ListarOBJETIVOParaAprovacaoExecutivo"
                    TypeName="GPO.DsAdmin.OBJETIVO" EnableViewState="False" OnSelecting="odsGrvPrincipal_Selecting">
                    <SelectParameters>
