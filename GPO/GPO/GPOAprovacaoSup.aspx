<%@ Page Language="C#" MasterPageFile="~/masterpages/Interno.master" AutoEventWireup="true" CodeFile="GPOAprovacaoSup.aspx.cs" Inherits="GPOAprovacaoSup" %>
...
document.aspnetForm.submit();
    ...
    <asp:UpdatePanel ID="upnPrincipal" runat="server">
        <ContentTemplate>
            <h1>
                <asp:Label ID="lblTitulo" runat="server" EnableViewState="False">Aprovação Superior</asp:Label></h1>
            <br />
            <asp:Panel ID="pnlIncluir" runat="server">
                ...
                <div id="botao">
                    ...
                    <asp:Button ID="btnAprovar" runat="server" Text="Aprovar" Width="80px" OnClientClick="return(confirm('Confirma a aprovação dos objetivos selecionados \n e recusa dos objetivos não selecionados?'))"
