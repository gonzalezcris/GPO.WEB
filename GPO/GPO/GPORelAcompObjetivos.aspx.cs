...
public partial class GPORelAcompObjetivos : System.Web.UI.Page
{
    #region " Load "
    ...
    protected void btnImprimir_Click(object sender, System.EventArgs e)
    {
        ...
        Session["RAO_ID_EMPRESA"] = ID_EMPRESA.SelectedValue;
        Session["RAO_SG_EMPRESA"] = ID_EMPRESA.SelectedItem.Text;
        Session["RAO_ID_EXECUTIVO"] = ID_EXECUTIVO.SelectedValue;
        Session["RAO_DS_EXECUTIVO"] = ID_EXECUTIVO.SelectedItem.Text;
        Session["RAO_ANO"] = ANO.SelectedValue;
        //Session["RAO_"] = ANO.SelectedItem.Text;
        Session["RAO_ID_OBJETIVO"] = ID_OBJETIVO.SelectedValue;
        Session["RAO_DS_OBJETIVO"] = ID_OBJETIVO.SelectedItem.Text;

        ScriptManager.RegisterClientScriptBlock(this.Page, btnImprimir.GetType(), "conf", "<script>window.open('GPORelAcompObjetivosImp.aspx');</script>", false);
    }
