...
public partial class GPORelFolhaDescricaoObjetivos : System.Web.UI.Page
{
    #region " Load "
    ...
    protected void btnImprimir_Click(object sender, System.EventArgs e)
    {
        ...
        Session["RFDO_ID_EMPRESA"] = ID_EMPRESA.SelectedValue;
        Session["RFDO_SG_EMPRESA"] = ID_EMPRESA.SelectedItem.Text;
        Session["RFDO_ID_EXECUTIVO"] = ID_EXECUTIVO.SelectedValue;
        Session["RFDO_DS_EXECUTIVO"] = ID_EXECUTIVO.SelectedItem.Text;
        Session["RFDO_ANO"] = ANO.SelectedValue;
        ...
        ScriptManager.RegisterClientScriptBlock(this.Page, btnImprimir.GetType(), "conf", "<script>window.open('GPORelFolhaDescricaoObjetivosImp.aspx');</script>", false);
    }
