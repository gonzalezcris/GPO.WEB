...
public partial class GPORelAvalQuantitativaOrgao : System.Web.UI.Page
{
    #region " Load "
    ...
    protected void btnImprimir_Click(object sender, System.EventArgs e)
    {
        ...
        Session["RAQO_ID_EMPRESA"] = ID_EMPRESA.SelectedValue;
        Session["RAQO_SG_EMPRESA"] = ID_EMPRESA.SelectedItem.Text;
        Session["RAQO_ID_EXECUTIVO"] = ID_EXECUTIVO.SelectedValue;
        Session["RAQO_DS_EXECUTIVO"] = ID_EXECUTIVO.SelectedItem.Text;
        Session["RAQO_MES"] = MES.SelectedValue;
        Session["RAQO_DS_MES"] = MES.SelectedItem.Text;
        Session["RAQO_ANO"] = ANO.SelectedValue;
        //Session["RFDO_"] = ANO.SelectedItem.Text;

        ScriptManager.RegisterClientScriptBlock(this.Page, btnImprimir.GetType(), "conf", "<script>window.open('GPORelAvalQuantitativaOrgaoImp.aspx');</script>", false);
    }
